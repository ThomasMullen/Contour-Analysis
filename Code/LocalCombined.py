...
def test_function():
    ...
    # Plot a histogram of the volume difference seperated by recurrence after cuts
    patients_recur, patients_dont_recur = separate_by_recurrence(enhancedDF)
    plot_histogram_with_two_data_sets(patients_recur['volumeContourDifference'], 'red', 30, patients_dont_recur['volumeContourDifference'], 'green', 30)
