...
new_path = SaveDirect + 'General/PotentialAnomolies16Frac.txt'
stats = open(new_path,'w')
stats.write("Recur patients > 50: \n")
stats.write(str(PatientRecurrencew16Frac.query("volumeContourDifference > 50").patientList))
stats.write("\n Recur patients < -50: \n")
stats.write(str(PatientRecurrencew16Frac.query("volumeContourDifference < -50").patientList))
stats.write("\n Non-Recur patients > 50: \n")
stats.write(str(PatientNonRecurrencew16Frac.query("volumeContourDifference > 50").patientList))
stats.write("\n Non-Recur patients < -50: \n")
stats.write(str(PatientNonRecurrencew16Frac.query("volumeContourDifference < -50").patientList))
stats.close()